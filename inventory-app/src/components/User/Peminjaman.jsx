...
const Icon = {
  ...
  Briefcase: () => (<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" /><line x1="12" y1="12" x2="12" y2="12" /></svg>),
  Tag: () => (<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" /><line x1="7" y1="7" x2="7.01" y2="7" /></svg>),
};
...
// ─── MOCK PEKERJAAN (from Excel, Capex) ──────────────────────
const mockPekerjaan = [
  {
    kode: "2440020-A",
    no_anggaran: "2440020",
...
// ─── MOCK ASSETS (with pekerjaan_kode) ────────────────────────
const mockAssets = [
  { code: "SPMT-LPT-01", name: "Laptop Lenovo ThinkPad X1", zone: "Ruang IT", pekerjaan_kode: "2540011-C" },
  { code: "SPMT-LPT-02", name: "Laptop Dell Latitude 5420", zone: "Terminal 1", pekerjaan_kode: "2440020-A" },
  { code: "SPMT-LPT-03", name: "Laptop HP EliteBook 840", zone: "Terminal 2", pekerjaan_kode: "2440020-A" },
  { code: "SPMT-PC-01", name: "PC Desktop HP EliteDesk", zone: "Ruang Admin", pekerjaan_kode: "2440020-B" },
  { code: "SPMT-PC-02", name: "PC Desktop Dell OptiPlex", zone: "Terminal 1", pekerjaan_kode: "2440020-B" },
  { code: "SPMT-SRV-01", name: "Server HP ProLiant DL380", zone: "Data Center", pekerjaan_kode: "2540011-C" },
  { code: "SPMT-SWT-01", name: "Switch Cisco Catalyst 9300", zone: "Ruang Network", pekerjaan_kode: "2540011-C" },
  { code: "SPMT-RTR-01", name: "Router Mikrotik CCR2004", zone: "Ruang Network", pekerjaan_kode: "2540012-A" },
  { code: "SPMT-UPS-01", name: "UPS APC Smart-UPS 3000", zone: "Data Center", pekerjaan_kode: "2540011-D" },
  { code: "SPMT-NET-01", name: "Access Point Ubiquiti UniFi", zone: "Terminal 1", pekerjaan_kode: "2540011-A" },
  { code: "SPMT-NET-02", name: "CCTV Hikvision DS-2CD", zone: "Gate Area", pekerjaan_kode: "2540011-D" },
  { code: "SPMT-NET-03", name: "Public Announcer Bosch Praesideo", zone: "Terminal 2", pekerjaan_kode: "2540011-B" },
  { code: "SPMT-NET-04", name: "Radio Point-To-Point Ubiquiti", zone: "Ruang Network", pekerjaan_kode: "2440020-B" },
  { code: "SPMT-NET-05", name: "Firewall Fortinet FortiGate", zone: "Data Center", pekerjaan_kode: "2540010-A" },
];
...
const initBorrows = [
  { id: 1, pekerjaan_kode: "2540011-C", code: "SPMT-LPT-01", name: "Laptop Lenovo ThinkPad X1", borrow_date: "2026-02-10T09:00:00", due_date: "2026-03-10", performed_by_id: 1, giver_id: 2, receiver_id: 3, from_zone: "Ruang IT", to_zone: "Terminal 2", reason: "Kebutuhan operasional proyek", condition: "GOOD", attachment: "ba_pinjam_lpt01.pdf", notes: "Dibawa ke lokasi proyek", is_returned: false },
  { id: 2, pekerjaan_kode: "2440020-A", code: "SPMT-LPT-03", name: "Laptop HP EliteBook 840", borrow_date: "2026-02-20T10:00:00", due_date: "2026-03-05", performed_by_id: 1, giver_id: 1, receiver_id: 4, from_zone: "Terminal 2", to_zone: "Terminal 1", reason: "Rotasi aset antar terminal", condition: "GOOD", attachment: null, notes: "", is_returned: false },
  { id: 3, pekerjaan_kode: "2440020-B", code: "SPMT-PC-01", name: "PC Desktop HP EliteDesk", borrow_date: "2026-01-15T08:00:00", due_date: "2026-02-15", performed_by_id: 1, giver_id: 2, receiver_id: 2, from_zone: "Ruang Admin", to_zone: "Terminal 3", reason: "Penggantian sementara unit rusak", condition: "GOOD", attachment: "ba_pinjam_pc01.pdf", notes: "Unit pengganti sementara", is_returned: false },
  { id: 4, pekerjaan_kode: "2540011-C", code: "SPMT-SWT-01", name: "Switch Cisco Catalyst 9300", borrow_date: "2026-02-28T14:00:00", due_date: "2026-03-28", performed_by_id: 1, giver_id: 5, receiver_id: 1, from_zone: "Ruang Network", to_zone: "Data Center", reason: "Upgrade infrastruktur jaringan", condition: "GOOD", attachment: null, notes: "", is_returned: false },
  { id: 5, pekerjaan_kode: "2440020-A", code: "SPMT-LPT-02", name: "Laptop Dell Latitude 5420", borrow_date: "2026-03-01T11:00:00", due_date: "2026-04-01", performed_by_id: 1, giver_id: 1, receiver_id: 5, from_zone: "Terminal 1", to_zone: "Medan - Kantor Cabang", reason: "Keperluan dinas luar kota", condition: "GOOD", attachment: "ba_pinjam_lpt02.pdf", notes: "", is_returned: false },
];

const initReturns = [
  { id: 101, original_id: 3, pekerjaan_kode: "2440020-B", code: "SPMT-PC-02", name: "PC Desktop Dell OptiPlex", borrow_date: "2025-11-01T09:00:00", return_date: "2025-12-01T14:30:00", performed_by_id: 1, giver_id: 2, receiver_id: 2, from_zone: "Ruang Admin", to_zone: "Terminal 1", reason: "Keperluan proyek", return_condition: "GOOD", return_notes: "Dikembalikan dalam kondisi baik", attachment: "ba_kembali_pc02.pdf" },
  { id: 102, original_id: null, pekerjaan_kode: "2540011-D", code: "SPMT-UPS-01", name: "UPS APC Smart-UPS 3000", borrow_date: "2025-10-05T08:00:00", return_date: "2025-11-05T10:00:00", performed_by_id: 1, giver_id: 3, receiver_id: 3, from_zone: "Data Center", to_zone: "Terminal 2", reason: "Backup power darurat", return_condition: "MINOR_DAMAGE", return_notes: "Terdapat goresan pada casing", attachment: null },
  { id: 103, original_id: 1, pekerjaan_kode: "2540011-C", code: "SPMT-LPT-01", name: "Laptop Lenovo ThinkPad X1", borrow_date: "2025-09-10T09:00:00", return_date: "2025-10-10T16:00:00", performed_by_id: 1, giver_id: 1, receiver_id: 1, from_zone: "Ruang IT", to_zone: "Terminal 3", reason: "Dinas luar kantor", return_condition: "GOOD", return_notes: "", attachment: "ba_kembali_lpt01.pdf" },
];
...
<table class="detail">
  <tr><td>No. Anggaran</td><td>:</td><td><strong>${pekerjaan.no_anggaran}</strong></td></tr>
  <tr><td>Jenis Anggaran</td><td>:</td><td>${pekerjaan.jenis}</td></tr>
  <tr><td>Nama Pekerjaan</td><td>:</td><td>${pekerjaan.nama}</td></tr>
</table>` : ""}
...
<div class="pernyataan">
  ...
  ${isBorrow ? `Pihak penerima wajib mengembalikan aset paling lambat pada tanggal <strong>${fmtDate(item.due_date)}</strong>.` : `Aset dinyatakan telah dikembalikan kepada pihak pemberi dalam kondisi <strong>${kondisi?.label}</strong>.`}
</div>
...
<div class="footer-note">
  ...
  Nomor referensi: <strong>${nomorBAST}</strong>. Harap simpan dokumen ini sebagai bukti serah terima resmi.
</div>
<div class="no-print" style="margin-top:24px; text-align:center;">
  <button onclick="window.print()" style="padding:10px 28px; background:#003675; color:white; border:none; border-radius:8px; font-size:13pt; cursor:pointer; font-family:inherit;">🖨️ Cetak / Simpan PDF</button>
</div>
</body>
</html>`;
...
/* Pekerjaan badge in table */
.pjm-pkj-badge { display: inline-flex; align-items: center; gap: 4px; font-size: .72rem; font-weight: 700; color: #0891b2; background: #ecfeff; border: 1px solid #a5f3fc; border-radius: 5px; padding: 2px 7px; white-space: nowrap; max-width: 200px; overflow: hidden; text-overflow: ellipsis; }
...
.pjm-modal--form { max-width: 640px; }
...
/* ── PEKERJAAN SELECTOR ── */
.pjm-pkj-list { display: flex; flex-direction: column; gap: .45rem; max-height: 280px; overflow-y: auto; }
.pjm-pkj-item { display: flex; align-items: flex-start; gap: .75rem; padding: .75rem 1rem; border: 1.5px solid var(--border); border-radius: 10px; cursor: pointer; background: #fff; transition: all .15s; text-align: left; font-family: inherit; width: 100%; }
...
.pjm-pkj-no { font-size: .72rem; font-weight: 800; color: #0891b2; background: #ecfeff; border: 1px solid #a5f3fc; border-radius: 5px; padding: 2px 7px; white-space: nowrap; flex-shrink: 0; margin-top: 2px; }
.pjm-pkj-jenis { font-size: .7rem; font-weight: 700; padding: 2px 7px; border-radius: 5px; white-space: nowrap; flex-shrink: 0; margin-top: 2px; }
...
.pjm-pkj-nama { font-size: .82rem; font-weight: 600; color: var(--slate); line-height: 1.4; flex: 1; }
.pjm-pkj-nama-active { color: var(--blue-dk); }
.pjm-pkj-check { width: 18px; height: 18px; border-radius: 50%; background: var(--blue); color: white; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 2px; }

/* Pekerjaan selected card */
.pjm-pkj-selected-card { display: flex; align-items: flex-start; gap: .75rem; padding: .75rem 1rem; border: 1.5px solid var(--blue); border-radius: 10px; background: var(--blue-lt); }
.pjm-pkj-selected-info { flex: 1; }
.pjm-pkj-selected-name { font-size: .83rem; font-weight: 600; color: var(--blue-dk); line-height: 1.4; }
.pjm-pkj-selected-meta { font-size: .74rem; color: var(--slate-6); margin-top: 3px; display: flex; gap: 8px; }
.pjm-pkj-change-btn { background: none; border: none; cursor: pointer; color: var(--blue); font-size: .76rem; font-weight: 700; padding: 2px 6px; border-radius: 5px; white-space: nowrap; transition: background .15s; font-family: inherit; }
.pjm-pkj-change-btn:hover { background: #bfdbfe; }

/* Asset count badge in pekerjaan selector */
.pjm-pkj-aset-cnt { font-size: .7rem; font-weight: 700; background: var(--bg); color: var(--slate-6); border: 1px solid var(--border); padding: 1px 6px; border-radius: 99px; margin-top: 2px; white-space: nowrap; }
...
function ActionDropdown({ id, activeId, setActiveId, items }) {
  ...
  useEffect(() => {
    const handler = (e) => { if (ref.current && !ref.current.contains(e.target)) { if (activeId === id) setActiveId(null); } };
  ...
  return (
    <div className="pjm-action-wrap" ref={ref}>
      <button className="pjm-dot-btn" onClick={(e) => { e.stopPropagation(); setActiveId(isOpen ? null : id); }}><Icon.Dots /></button>
      {isOpen && (
...
// ─── SEARCHABLE COMBOBOX ───────────────────────────────────────
function SearchCombobox({ options, value, onChange, placeholder, renderLabel, renderSub, hasError, disabled }) {
  ...
  return (
    <div className="pjm-combo" ref={ref} style={disabled ? { opacity: .55, pointerEvents: "none" } : {}}>
      <div className={`pjm-combo-input-wrap ${open ? "open" : ""} ${hasError ? "pjm-err-border" : ""}`} onClick={() => !disabled && setOpen(!open)}>
      ...
      {open && (
        <div className="pjm-combo-dropdown">
          ...
          {filtered.length === 0
            ...
            : filtered.map(o => (
              <button key={o.value} type="button" className={`pjm-combo-item ${String(o.value) === String(value) ? "selected" : ""} ${o.disabled ? "pjm-combo-item--disabled" : ""}`} onClick={() => { if (!o.disabled) { onChange(o.value); setOpen(false); setQuery(""); } }}>
...
// ─── PEKERJAAN SELECTOR COMPONENT ─────────────────────────────
function PekerjaanSelector({ value, onChange, error }) {
  const [search, setSearch] = useState("");
  const selected = mockPekerjaan.find(p => p.kode === value);

  const filtered = mockPekerjaan.filter(p =>
    p.nama.toLowerCase().includes(search.toLowerCase()) ||
    p.no_anggaran.includes(search) ||
    p.kode.toLowerCase().includes(search.toLowerCase())
  );

  const getAssetCount = (kode) => mockAssets.filter(a => a.pekerjaan_kode === kode).length;

  if (selected) {
    return (
      <div className="pjm-pkj-selected-card">
        <span style={{ color: "#0891b2", display: "flex", marginTop: 2, flexShrink: 0 }}><Icon.Briefcase /></span>
        <div className="pjm-pkj-selected-info">
          ...
          <div className="pjm-pkj-selected-meta">
            <span style={{ fontWeight: 700, color: "#0891b2" }}>{selected.no_anggaran}</span>
            <span>·</span>
            <span className={`pjm-pkj-jenis pjm-pkj-jenis--${selected.jenis.toLowerCase()}`}>{selected.jenis}</span>
            <span>·</span>
            <span>{getAssetCount(selected.kode)} aset tersedia</span>
          </div>
        </div>
        <button type="button" className="pjm-pkj-change-btn" onClick={() => onChange("")}>Ganti</button>
      </div>
    );
  }
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: ".5rem" }}>
      <div className="pjm-search-wrap" style={{ minWidth: "unset" }}>
        <Icon.Search />
        <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Cari nama pekerjaan atau nomor anggaran..." style={{ border: "none", outline: "none", fontSize: ".845rem", flex: 1, background: "transparent", fontFamily: "inherit" }} />
        {search && <button style={{ background: "none", border: "none", cursor: "pointer", color: "var(--slate-4)", padding: 0, display: "flex" }} onClick={() => setSearch("")}><Icon.Times /></button>}
      </div>
      {error && <span className="pjm-ferr">{error}</span>}
      <div className="pjm-pkj-list">
        {filtered.length === 0 ? (
          <div style={{ textAlign: "center", padding: "1.5rem", color: "var(--slate-4)", fontSize: ".84rem" }}>Tidak ada pekerjaan ditemukan</div>
        ) : filtered.map(p => {
          const cnt = getAssetCount(p.kode);
          return (
            <button key={p.kode} type="button" className={`pjm-pkj-item ${value === p.kode ? "pjm-pkj-item--active" : ""}`} onClick={() => onChange(p.kode)}>
              <span className="pjm-pkj-no">{p.no_anggaran}</span>
              <span className={`pjm-pkj-jenis pjm-pkj-jenis--${p.jenis.toLowerCase()}`}>{p.jenis}</span>
              <span className={`pjm-pkj-nama ${value === p.kode ? "pjm-pkj-nama-active" : ""}`}>{p.nama}</span>
              <span className="pjm-pkj-aset-cnt">{cnt} aset</span>
              {value === p.kode && <span className="pjm-pkj-check"><Icon.Check /></span>}
            </button>
          );
        })}
      </div>
...
function BorrowFormModal({ borrow, onClose, onSave }) {
  ...
  // Filter assets by selected pekerjaan
  ...
  const assetOptions = availableAssets.map(a => ({
    value: a.code, label: a.code, sub: a.name, zone: a.zone, fullName: a.name
  }));

  const userOptions = mockUsers.map(u => ({ value: u.id, label: u.name, sub: u.branch }));

  const handlePekerjaanChange = (kode) => {
    // Reset asset when pekerjaan changes
    setForm(f => ({ ...f, pekerjaan_kode: kode, code: "", from_zone: "", name: "" }));
  };

  const handleAssetChange = (code) => {
    const asset = getAsset(code);
    setForm(f => ({ ...f, code, from_zone: asset?.zone || "", name: asset?.name || "" }));
  };

  const validate = () => {
    const e = {};
    if (!form.pekerjaan_kode) e.pekerjaan_kode = "Wajib pilih pekerjaan terlebih dahulu";
  ...
  const selectedPekerjaan = mockPekerjaan.find(p => p.kode === form.pekerjaan_kode);
      ...
      <div className="pjm-modal pjm-modal--form" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="pjm-modal-body">
          ...
          <div className="pjm-form-section">
            <span className="pjm-form-section-label" style={{ color: "#0891b2" }}>
              <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
                <span style={{ width: 18, height: 18, borderRadius: "50%", background: "#0891b2", color: "white", fontSize: ".68rem", fontWeight: 800, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>1</span>
                Pilih Pekerjaan
              </span>
            </span>
          ...
          <div className="pjm-fg">
            <label>
              ...
              <span style={{ marginLeft: 6, fontSize: ".72rem", fontWeight: 400, color: "var(--slate-4)" }}>— Pilih terlebih dahulu untuk memfilter aset</span>
            </label>
            <PekerjaanSelector
          ...
          {/* STEP 2 — PILIH ASET */}
          <div className="pjm-form-section">
            <span className="pjm-form-section-label" style={{ color: form.pekerjaan_kode ? "var(--blue)" : "var(--slate-4)" }}>
              <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
                <span style={{ width: 18, height: 18, borderRadius: "50%", background: form.pekerjaan_kode ? "var(--blue)" : "var(--slate-4)", color: "white", fontSize: ".68rem", fontWeight: 800, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>2</span>
                Pilih Aset
              </span>
            </span>
            <div className="pjm-form-section-line" />
          ...
          <div className="pjm-fg">
            <label>
              ...
              {selectedPekerjaan && (
                <span style={{ marginLeft: 6, fontSize: ".72rem", fontWeight: 600, color: "#0891b2" }}>
                  — {availableAssets.length} aset tersedia untuk pekerjaan ini
                </span>
              )}
            </label>
            {!form.pekerjaan_kode ? (
              <div style={{ padding: ".75rem 1rem", background: "#f8fafc", border: "1.5px dashed var(--border)", borderRadius: 9, fontSize: ".835rem", color: "var(--slate-4)", display: "flex", alignItems: "center", gap: 8 }}>
                <Icon.ArrowRight />
                Pilih pekerjaan terlebih dahulu untuk melihat daftar aset
              </div>
            ) : (
              <>
                <SearchCombobox
                ...
                {availableAssets.length === 0 && (
                  <span style={{ fontSize: ".78rem", color: "var(--warn)", fontWeight: 600 }}>
                    ⚠ Tidak ada aset yang terdaftar untuk pekerjaan ini
                  </span>
                )}
              </>
            )}
          ...
          {/* STEP 3 — PIHAK-PIHAK */}
          <div className="pjm-form-section">
            <span className="pjm-form-section-label" style={{ color: form.code ? "#d97706" : "var(--slate-4)" }}>
              <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
                <span style={{ width: 18, height: 18, borderRadius: "50%", background: form.code ? "#d97706" : "var(--slate-4)", color: "white", fontSize: ".68rem", fontWeight: 800, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>3</span>
                Pihak yang Terlibat
              </span>
            </span>
            <div className="pjm-form-section-line" />
          ...
          {/* STEP 4 — WAKTU & LOKASI */}
          <div className="pjm-form-section">
            <span className="pjm-form-section-label" style={{ color: "var(--slate-6)" }}>
              <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
                <span style={{ width: 18, height: 18, borderRadius: "50%", background: "var(--slate-4)", color: "white", fontSize: ".68rem", fontWeight: 800, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>4</span>
                Waktu & Lokasi
              </span>
            </span>
            <div className="pjm-form-section-line" />
          ...
          <div className="pjm-form-section">
            <span className="pjm-form-section-label" style={{ color: "var(--slate-6)" }}>
              <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
                <span style={{ width: 18, height: 18, borderRadius: "50%", background: "var(--slate-4)", color: "white", fontSize: ".68rem", fontWeight: 800, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>5</span>
                Kondisi & Dokumen BAST
              </span>
            </span>
            <div className="pjm-form-section-line" />
          </div>
...
function ReturnFormModal({ borrow, onClose, onSave }) {
  ...
  const handleSave = () => {
    onSave({
      ...
      performed_by_id: LOGGED_IN_ADMIN_ID,
      giver_id: borrow.receiver_id, receiver_id: borrow.giver_id,
  ...
  const handleGenerateBAST = () => {
    const tempItem = {
      ...borrow, giver_id: borrow.receiver_id, receiver_id: borrow.giver_id,
      return_date: form.return_date, return_condition: form.return_condition, return_notes: form.return_notes,
    };
      ...
      <div className="pjm-modal pjm-modal--form" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="pjm-modal-body">
          {borrow.pekerjaan_kode && (() => {
            ...
            return pkj ? (
              <div style={{ display: "flex", alignItems: "flex-start", gap: ".6rem", padding: ".65rem 1rem", background: "#ecfeff", border: "1px solid #a5f3fc", borderRadius: 10 }}>
                <span style={{ color: "#0891b2", display: "flex", marginTop: 2, flexShrink: 0 }}><Icon.Briefcase /></span>
                <div>
                  <div style={{ fontSize: ".72rem", fontWeight: 800, color: "#0891b2", textTransform: "uppercase", letterSpacing: ".04em" }}>Pekerjaan</div>
                  <div style={{ fontSize: ".82rem", fontWeight: 600, color: "#0e7490", lineHeight: 1.4 }}>{pkj.nama}</div>
                  <div style={{ fontSize: ".72rem", color: "#0891b2", marginTop: 2 }}>{pkj.no_anggaran} · {pkj.jenis}</div>
                </div>
              </div>
            ) : null;
          })()}
          ...
          {!form.attachmentFile && (
            <div className="pjm-bast-note">
              <span className="pjm-bast-note-icon">✨</span>
              <div><strong>Generate BAST Pengembalian</strong> — Klik tombol di bawah untuk membuat Berita Acara Pengembalian secara otomatis.</div>
            </div>
          )}
        </div>
        <div className="pjm-modal-footer">
          <button className="pjm-btn pjm-btn-ghost" onClick={onClose}>Batal</button>
          {!form.attachmentFile && (
            <button className="pjm-btn pjm-btn-purple" onClick={handleGenerateBAST}><Icon.Printer /> Generate BAST</button>
          )}
        ...
        <div className="pjm-modal-body">
          {pekerjaan && (
            <div style={{ display: "flex", alignItems: "flex-start", gap: ".6rem", padding: ".65rem 1rem", background: "#ecfeff", border: "1px solid #a5f3fc", borderRadius: 10 }}>
              <span style={{ color: "#0891b2", display: "flex", marginTop: 2, flexShrink: 0 }}><Icon.Briefcase /></span>
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: ".72rem", fontWeight: 800, color: "#0891b2", textTransform: "uppercase", letterSpacing: ".04em" }}>Pekerjaan / Anggaran</div>
                <div style={{ fontSize: ".82rem", fontWeight: 600, color: "#0e7490", lineHeight: 1.4 }}>{pekerjaan.nama}</div>
                <div style={{ fontSize: ".72rem", color: "#0891b2", marginTop: 2 }}>{pekerjaan.no_anggaran} · {pekerjaan.jenis}</div>
              </div>
            </div>
          )}
                    ...
                    <td>
                      {pkj ? (
                        <div style={{ maxWidth: 200 }}>
                          <div className="pjm-pkj-badge"><Icon.Tag />{pkj.no_anggaran}</div>
                          <div style={{ fontSize: ".72rem", color: "var(--slate-6)", marginTop: 3, lineHeight: 1.3 }}>{pkj.nama.length > 60 ? pkj.nama.slice(0, 60) + "…" : pkj.nama}</div>
                        </div>
                      ) : <span className="pjm-text-muted" style={{ fontSize: ".77rem" }}>—</span>}
                    </td>
...
// ─── ASSET HISTORY MODAL WRAPPER ──────────────────────────────
function AssetHistoryModalWrapper({ historyModal, borrows, returns, onClose }) {
...
export default function Peminjaman() {
  ...
  const filteredBorrows = activeBorrows.filter(b => {
    ...
    const mp = filterPekerjaan === "semua" || b.pekerjaan_kode === filterPekerjaan;
    return ms && mu && mp;
  });
  ...
  return (
    <div className="pjm-root">
          ...
          <>
            <div className="pjm-filter-wrap">
              ...
              <select value={filterPekerjaan} onChange={(e) => setFilterPekerjaan(e.target.value)}>
                ...
                {mockPekerjaan.map(p => <option key={p.kode} value={p.kode}>{p.no_anggaran} — {p.nama.slice(0, 50)}…</option>)}
              </select>
            </div>
            <div className="pjm-filter-wrap">
              <Icon.User />
          ...
          {filteredReturns.length === 0 ? (
            ...
            <div className="pjm-table-wrap">
              <table className="pjm-table pjm-table--ret">
                <thead>
                  <tr><th>Aset</th><th>Pekerjaan</th><th>Pemberi → Penerima</th><th>Dari → Ke</th><th>Tgl Pinjam</th><th>Tgl Dikembalikan</th><th>Kondisi Kembali</th><th>Catatan</th><th>BAST</th><th>Aksi</th></tr>
                </thead>
                <tbody>
                        ...
                        <td>
                          {pkj ? (
                            <div style={{ maxWidth: 180 }}>
                              <div className="pjm-pkj-badge"><Icon.Tag />{pkj.no_anggaran}</div>
                              <div style={{ fontSize: ".71rem", color: "var(--slate-6)", marginTop: 3, lineHeight: 1.3 }}>{pkj.nama.length > 50 ? pkj.nama.slice(0, 50) + "…" : pkj.nama}</div>
                            </div>
                          ) : <span className="pjm-text-muted" style={{ fontSize: ".77rem" }}>—</span>}
                        </td>
      ...
      <AssetHistoryModalWrapper historyModal={historyModal} borrows={borrows} returns={returns} onClose={() => setHistoryModal(null)} />
    </div>
  );
}