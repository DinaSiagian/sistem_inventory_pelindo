...
const initMockCapex = [
  ...
  },
  {
    ...
    nilai_anggaran_rkap: 5500000000,
    thn_rkap_awal: 2026,
    thn_rkap_akhir: 2028,
    thn_anggaran: 2026,
    projects: [
      {
        id_pekerjaan: "PKJ-003",
...
// ══════════════════════════════════════════════════════════════════
// EDIT PANEL — CAPEX (inline drawer)
// ══════════════════════════════════════════════════════════════════
                  ...
                  <div key={proj.id_pekerjaan} className="bm-proj-edit-card">
                    <div className="bm-proj-edit-card-header">
                      ...
                      <span className="bm-proj-edit-card-title">
                        Pekerjaan #{idx + 1}
                        {proj.nm_pekerjaan ? ` — ${proj.nm_pekerjaan}` : ""}
                        {proj._new && (
                          <span
                            style={{
                              marginLeft: 8,
                      ...
                      <button
                        ...
                        onClick={() =>
                          setConfirm({
                            msg: `Hapus pekerjaan "${proj.nm_pekerjaan || `#${idx + 1}`}" beserta semua asetnya?`,
                            onConfirm: () => {
...
export default function BudgetManagement() {
  ...
  const [editingBudget, setEditingBudget] = useState(null); // id being edited
  ...
  const toggleBudget = (id) => {
    if (editingBudget === id) return; // don't collapse while editing
  ...
  const handleSaveEdit = (payload) => {
    if (payload.type === "opex") {
      // update realisasi list in state
