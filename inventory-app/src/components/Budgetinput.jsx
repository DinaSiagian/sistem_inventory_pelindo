...
function OpexModule({ masterList, setMasterList }) {
  ...
  const totalRealisasi = kpiBase.reduce(
    (s, m) =>
      s +
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      >
        {[
          {
            label:
              filterNama && filterNama !== "SEMUA"
                ? "Total Anggaran (dipilih)"
                : "Total Anggaran",
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <select
                    style={{
                      ...
                      border: filterThnFrom
                        ? "1px solid #bfdbfe"
                        : "1px solid #cbd5e1",
                      color: filterThnFrom ? "#1d4ed8" : "#334155",
                      fontWeight: filterThnFrom ? 600 : 400,
                      cursor: "pointer",
                    }}
                    value={filterThnFrom}
                ...
                <div
                  style={{
                    width: 16,
                    height: 2,
                    background: hasYearFilter ? "#bfdbfe" : "#cbd5e1",
                    borderRadius: 99,
                    flexShrink: 0,
                  }}
                />
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <select
                    style={{
                      ...
                      fontWeight: filterThnTo ? 600 : 400,
                      cursor: "pointer",
                    }}
                    value={filterThnTo}
        ...
        {!filterNama && (
          <div style={{ padding: "32px 24px", textAlign: "center" }}>
            ...
            <div style={{ fontSize: "0.82rem", color: "#94a3b8" }}>
              Gunakan dropdown "Pos Anggaran" di atas, atau filter tahun
              terlebih dahulu.
            </div>
          </div>
        )}
        ...
        <>
          {filteredMasters.length === 0 ? (
            ...
            >
              ...
              {filterNama !== "SEMUA" ? `dengan nama "${filterNama}"` : ""} pada
              rentang tahun yang dipilih.
            </div>
          ) : (
            <>
              {paginatedWithGlobalIdx.map(({ m, globalIdx }) => {
                const totalR = (m.realisasi_tahunan || []).reduce(
                  (s, r) =>
                    s + (r.realisasi_murni || 0) + (r.realisasi_bymhd || 0),
                  0,
                );
                const pct =
                  m.nilai_anggaran > 0
                      ...
                      >
                        {[
                          ...
                          },
                          {
                            ...
                            color:
                              totalR > m.nilai_anggaran ? "#dc2626" : "#16a34a",
                          },
                        ].map((item) => (
                          <div key={item.label}>
                            <div
        ...
        >
          ...
          <button
            style={{
              ...BTN,
              background: "#2563eb",
              opacity: nilaiKad || nilaiRkap ? 1 : 0.5,
              padding: "9px 20px",
              borderRadius: 8,
            }}
          ...
          <table style={{ ...TABLE, border: "none" }}>
            <thead>
              <tr>
                ...
                <th style={{ ...TH, width: 90, textAlign: "center" }}>
                  RKAP AWAL
                </th>
                <th style={{ ...TH, width: 90, textAlign: "center" }}>
                  RKAP AKHIR
                  ...
                  return (
                    <tr
                      ...
                      style={{
                        ...
                        background: isRkapAkhirLebih ? "#fffbeb" : "white",
                      }}
                      onMouseEnter={(e) =>
                        (e.currentTarget.style.background = isRkapAkhirLebih
                          ? "#fef9ec"
                          : "#f8faff")
                      }
                      onMouseLeave={(e) =>
                    ...
                    >
                      ...
                      <td style={{ ...TD, textAlign: "center" }}>
                        <span
                          style={{
                            background: isRkapAkhirLebih
                              ? "#fef3c7"
                              : "#f1f5f9",
                            color: isRkapAkhirLebih ? "#b45309" : "#64748b",
                            border: isRkapAkhirLebih
                              ? "1px solid #fde68a"
                              : "1px solid #e2e8f0",
                            padding: "3px 10px",
                            borderRadius: 99,
            ...
            {capexList.length > 0 && (
              <tfoot>
                <tr style={{ background: "#eff6ff" }}>
                  ...
                  >
                    {fmt(
                      capexList.reduce((s, c) => s + (c.nilai_rkap || 0), 0),
                    )}
                  </td>
                  <td style={TD} />
                </tr>
      ...
      {capexList.some((c) => c.thn_rkap_akhir > CURRENT_YEAR) && (
        ...
        >
          ...
          <span style={{ fontSize: "0.78rem", color: "#92400e" }}>
            Baris berwarna kuning menandakan CAPEX dengan RKAP akhir melewati
            tahun berjalan ({CURRENT_YEAR}). Klik tombol <b>Anggaran</b> pada
            baris tersebut untuk menginput data anggaran baru.
          </span>
        </div>
      )}
      ...
      {showAddForm && (
        <div style={OVS} onClick={() => setShowAddForm(false)}>
          ...
          >
            ...
            <div>
              ...
              <ModalFormRow label="Nama Anggaran" required>
                <textarea
                  ...
                  onChange={(e) =>
                    setNewCapex((f) => ({ ...f, nm_anggaran: e.target.value }))
                  }
                />
              </ModalFormRow>
              ...
              <ModalFormRow label="Kode CAPEX">
                <input
                  ...
                  onChange={(e) =>
                    setNewCapex((f) => ({ ...f, kd_capex: e.target.value }))
                  }
                />
              </ModalFormRow>
              ...
              <ModalFormRow label="Tahun Anggaran">
                <select
                  ...
                  onChange={(e) =>
                    setNewCapex((f) => ({ ...f, thn_anggaran: e.target.value }))
                  }
                >
                  {yearOpts.map((y) => (
                    <option key={y} value={y}>
              ...
              <ModalFormRow label="Nilai KAD (Rp)">
                <input
                  ...
                  onChange={(e) =>
                    setNewCapex((f) => ({ ...f, nilai_kad: e.target.value }))
                  }
                />
                {parseFloat(newCapex.nilai_kad) > 0 && (
                  <span style={{ fontSize: "0.78rem", color: "#64748b" }}>
                    ≈ {fmt(newCapex.nilai_kad)}
                  </span>
                )}
              </ModalFormRow>
              ...
              <ModalFormRow label="Nilai RKAP (Rp)" noBorder>
                <input
                  ...
                  onChange={(e) =>
                    setNewCapex((f) => ({ ...f, nilai_rkap: e.target.value }))
                  }
                />
                {parseFloat(newCapex.nilai_rkap) > 0 && (
                  <span style={{ fontSize: "0.78rem", color: "#64748b" }}>
                    ≈ {fmt(newCapex.nilai_rkap)}
                  </span>
                )}
              </ModalFormRow>
            </div>
            ...
            >
              <button style={BTNOUT} onClick={() => setShowAddForm(false)}>
                Batal
              </button>
              <button
                style={{
                  ...BTN,
                  background: "#2563eb",
                  opacity: newCapex.nm_anggaran ? 1 : 0.5,
                }}
            ...
            <div>
              ...
              <ModalFormRow label="Kode CAPEX">
                <input
                  ...
                  onChange={(e) =>
                    setEditTarget((t) => ({ ...t, kd_capex: e.target.value }))
                  }
                />
              </ModalFormRow>
              ...
              <ModalFormRow label="Nilai KAD (Rp)">
                <input
                  ...
                  onChange={(e) =>
                    setEditTarget((t) => ({ ...t, nilai_kad: e.target.value }))
                  }
                />
                {parseFloat(editTarget.nilai_kad) > 0 && (
                  <span style={{ fontSize: "0.78rem", color: "#64748b" }}>
                    ≈ {fmt(editTarget.nilai_kad)}
                  </span>
                )}
              </ModalFormRow>
              ...
              <ModalFormRow label="Nilai RKAP (Rp)" noBorder>
                <input
                  ...
                  onChange={(e) =>
                    setEditTarget((t) => ({ ...t, nilai_rkap: e.target.value }))
                  }
                />
                {parseFloat(editTarget.nilai_rkap) > 0 && (
                  <span style={{ fontSize: "0.78rem", color: "#64748b" }}>
                    ≈ {fmt(editTarget.nilai_rkap)}
                  </span>
                )}
              </ModalFormRow>
            </div>
        ...
        >
          {[
            ...
            },
            {
              ...
              count: `${capexList.length} data CAPEX`,
            },
          ].map((item) => (
            <div
              key={item.tipe}
