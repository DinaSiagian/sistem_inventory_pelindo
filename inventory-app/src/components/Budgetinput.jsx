...
import {
  ...
  Search, ChevronDown, AlertTriangle, Database, Layers, ChevronRight,
  Edit, Clock, Eye, History, Calendar, Pencil, PlusCircle,
} from "lucide-react";
...
const INIT_OPEX_MASTERS = [
  { id: "OPX-M-1", kd: "5030905000", nama: "Beban Pemeliharaan Software", thn_anggaran: 2026, nilai_anggaran: 350000000,
    realisasi_tahunan: [{ id: uid(), thn: 2026, realisasi_murni: 900000000, realisasi_bymhd: 100000000,
      history: [
  ...
  { id: "OPX-M-2", kd: "5021300000", nama: "Beban Jaringan dan Koneksi Data", thn_anggaran: 2026, nilai_anggaran: 288000000,
    realisasi_tahunan: [{ id: uid(), thn: 2026, realisasi_murni: 240000000, realisasi_bymhd: 0,
  ...
  { id: "OPX-M-4", kd: "5081500000", nama: "Beban Jasa Konsultan", thn_anggaran: 2026, nilai_anggaran: 800000000,
    realisasi_tahunan: [{ id: uid(), thn: 2026, realisasi_murni: 150000000, realisasi_bymhd: 0,
  ...
  { id: "OPX-M-6", kd: "5030906000", nama: "Beban Pemeliharaan Hardware", thn_anggaran: 2026, nilai_anggaran: 450000000,
    realisasi_tahunan: [{ id: uid(), thn: 2026, realisasi_murni: 25000000, realisasi_bymhd: 0,
...
const INIT_CAPEX_FORM = [
  { id: "CAP-F-1", kd_master: "5900100000", nm_master: "Beban Investasi", nm_anggaran: "Implementasi dan Standarisasi IT Infrastruktur", kd_capex: "2440015", thn_rkap_awal: 2024, thn_rkap_akhir: 2024, thn_anggaran: 2024, nilai_kad: 0, nilai_rkap: 0, anggaran_tahunan: [], pekerjaan: [{ id: "PKJ-001", nm: "Pekerjaan Implementasi dan Standarisasi IT Infrastruktur PT Pelindo Multi Terminal", nilai_rab: 0, nilai_kontrak: 0, no_pr: "", no_po: "6440000026", no_kontrak: "SI.01/12/8/2/PPTI/TEKI/PLMT-24", tgl_kontrak: "2024-08-12", durasi_kontrak: 90, no_sp3: "", tgl_sp3: "", tgl_bamk: "2024-08-02", keterangan: "" }], history_anggaran: [] },
  { id: "CAP-F-2", kd_master: "5900100000", nm_master: "Beban Investasi", nm_anggaran: "Penyediaan Network di Branch SPMT", kd_capex: "2440014", thn_rkap_awal: 2024, thn_rkap_akhir: 2024, thn_anggaran: 2024, nilai_kad: 0, nilai_rkap: 0, anggaran_tahunan: [], pekerjaan: [], history_anggaran: [] },
  { id: "CAP-F-3", kd_master: "5900100000", nm_master: "Beban Investasi", nm_anggaran: "Penyiapan Infrastruktur IT (Kantor Pusat, Pelindo Place, Pelindo Tower, Malahayati, Lhokseumawe, Bima, Badas, Parepare, Gresik, Tanjung Emas, Mekar Putih, Meulaboh, Kuala Langsa dan Bumiharjo) PT Pelindo Multi Terminal", kd_capex: "2440013", thn_rkap_awal: 2024, thn_rkap_akhir: 2024, thn_anggaran: 2024, nilai_kad: 0, nilai_rkap: 0, anggaran_tahunan: [], pekerjaan: [], history_anggaran: [] },
  { id: "CAP-F-4", kd_master: "5900100000", nm_master: "Beban Investasi", nm_anggaran: "Revisi Capex (Pemenuhan Kebutuhan Gate dan PNC Transformasi pada Branch SPMT)", kd_capex: "2440020", thn_rkap_awal: 2024, thn_rkap_akhir: 2025, thn_anggaran: 2025, nilai_kad: 0, nilai_rkap: 0, anggaran_tahunan: [], pekerjaan: [], history_anggaran: [] },
  { id: "CAP-F-5", kd_master: "5900100000", nm_master: "Beban Investasi", nm_anggaran: "Transformasi dan Digitalisasi PT Pelindo Multi Terminal", kd_capex: "2540011", thn_rkap_awal: 2025, thn_rkap_akhir: 2026, thn_anggaran: 2025, nilai_kad: 0, nilai_rkap: 0, anggaran_tahunan: [], pekerjaan: [], history_anggaran: [] },
...
// ── SHARED STYLES ──────────────────────────────────────────────
const S = {
  ovs: { position:"fixed", inset:0, background:"rgba(15,23,42,.4)", display:"flex", alignItems:"center", justifyContent:"center", zIndex:9000, padding:20 },
  btn: { display:"inline-flex", alignItems:"center", gap:8, padding:"8px 16px", borderRadius:6, border:"none", background:"#2563eb", color:"white", fontSize:"0.85rem", fontWeight:500, cursor:"pointer" },
  btnOut: { display:"inline-flex", alignItems:"center", gap:8, padding:"8px 16px", borderRadius:6, border:"1px solid #cbd5e1", background:"white", color:"#334155", fontSize:"0.85rem", fontWeight:500, cursor:"pointer" },
  inp: { padding:"10px 14px", border:"1px solid #cbd5e1", borderRadius:6, fontSize:"0.85rem", color:"#1e293b", outline:"none", width:"100%", background:"white" },
  lbl: { fontSize:"0.75rem", fontWeight:700, letterSpacing:".5px", color:"#475569", textTransform:"uppercase" },
  th: { padding:"12px 14px", textAlign:"left", fontSize:"0.72rem", fontWeight:700, color:"#475569", borderBottom:"1px solid #e2e8f0", textTransform:"uppercase", letterSpacing:".4px", background:"#f8fafc" },
  td: { padding:"12px 14px", verticalAlign:"middle", borderBottom:"1px solid #e2e8f0", color:"#334155" },
  abtn: { display:"inline-flex", alignItems:"center", justifyContent:"center", padding:5, borderRadius:4, border:"1px solid #e2e8f0", background:"white", cursor:"pointer" },
  lrRow: { display:"flex", alignItems:"center", gap:0, borderBottom:"1px solid #f1f5f9", minHeight:52 },
  lrLabel: { flexShrink:0, width:220, padding:"12px 16px", fontSize:"0.72rem", fontWeight:700, color:"#64748b", textTransform:"uppercase", letterSpacing:"0.5px", background:"#f8fafc", alignSelf:"stretch", display:"flex", alignItems:"center", borderRight:"1px solid #f1f5f9" },
  lrValue: { flex:1, padding:"10px 16px", display:"flex", alignItems:"center", flexWrap:"wrap", gap:8 },
  mlrRow: { display:"flex", alignItems:"stretch", borderBottom:"1px solid #f1f5f9", minHeight:56 },
  mlrLabel: { flexShrink:0, width:180, padding:"14px 16px", fontSize:"0.72rem", fontWeight:700, color:"#64748b", textTransform:"uppercase", letterSpacing:"0.5px", background:"#f8fafc", borderRight:"1px solid #f1f5f9", display:"flex", alignItems:"center" },
  mlrValue: { flex:1, padding:"12px 16px", display:"flex", flexDirection:"column", justifyContent:"center", gap:4 },
...
function ToastMsg({ msg, onDone }) {
  ...
  return <div className="toast"><CheckCircle size={14} /> {msg}</div>;
}
  ...
  return (
    <div className="overlay" onClick={onCancel}>
      <div className="cbox" onClick={e => e.stopPropagation()}>
        <div style={{ width:48, height:48, background:"#fff7ed", borderRadius:"50%", display:"flex", alignItems:"center", justifyContent:"center", color:"#ea580c" }}><AlertTriangle size={24} /></div>
        <p style={{ fontSize:"0.9rem", fontWeight:600 }}>{msg}</p>
        <div style={{ display:"flex", gap:8, width:"100%" }}>
          <button className="btn" style={{ flex:1, justifyContent:"center", background:"white", border:"1px solid #e5e7eb", color:"#374151" }} onClick={onCancel}>Batal</button>
          <button className="btn" style={{ flex:1, justifyContent:"center", background:"#dc2626", color:"#fff" }} onClick={onConfirm}><Trash2 size={14} /> Hapus</button>
        </div>
      </div>
    </div>
  );
...
function ModalFormRow({ label, required, helper, children, noBorder }) {
  return (
    <div style={{ ...S.mlrRow, borderBottom: noBorder ? "none" : "1px solid #f1f5f9" }}>
      <div style={S.mlrLabel}>{label}{required && <span style={{ color:"#ef4444", marginLeft:2 }}>*</span>}</div>
      <div style={S.mlrValue}>{children}{helper && <span style={{ fontSize:"0.72rem", color:"#94a3b8" }}>{helper}</span>}</div>
    </div>
  );
}
...
function InlineEditField({ label, value, onSave, type = "text" }) {
  ...
  const tdLabel = { ...S.td, width:220, fontWeight:600, fontSize:"0.72rem", color:"#64748b", textTransform:"uppercase", letterSpacing:"0.5px", background:"#f8fafc" };
    ...
    <tr>
      ...
      <td style={S.td}>
        {editing ? (
          <div>
            {isYear ? (
              <select style={{ ...S.inp, width:"100%", maxWidth:160 }} value={val} onChange={e => setVal(e.target.value)} autoFocus>
                {yearOpts.map(y => <option key={y} value={y}>{y}</option>)}
              </select>
            ) : (
              <input type={isCurrency ? "number" : "text"} className={isCurrency ? "no-spinners" : ""} style={{ ...S.inp, width:"100%", maxWidth:320 }} value={val} onChange={e => setVal(e.target.value)} autoFocus />
            )}
            {isCurrency && parseFloat(val) > 0 && <div style={{ marginTop:4, fontSize:"0.78rem", color:"#64748b" }}>≈ {fmt(val)}</div>}
          </div>
        ) : (
          <span style={{ fontWeight: isCurrency ? 800 : 700, color: isCurrency ? "#2563eb" : "#1e293b", fontSize: isCurrency ? "0.95rem" : "0.9rem" }}>
      ...
      <td style={{ ...S.td, width:100, textAlign:"right" }}>
        {editing ? (
          <div style={{ display:"flex", gap:6, justifyContent:"flex-end" }}>
            <button style={{ ...S.btn, background:"#16a34a", padding:"5px 12px", fontSize:"0.78rem" }} onClick={handleSave}><CheckCircle size={13} /> Simpan</button>
            <button style={{ ...S.btnOut, padding:"5px 10px", fontSize:"0.78rem" }} onClick={() => { setVal(value); setEditing(false); }}><X size={13} /></button>
          </div>
        ) : (
          <button style={{ ...S.abtn, color:"#d97706", borderColor:"#fde68a", background:"#fffbeb" }} onClick={() => setEditing(true)}>
            <Pencil size={13} style={{ color:"#d97706" }} /><span style={{ fontSize:"0.72rem", color:"#d97706", fontWeight:600 }}>Edit</span>
          </button>
        )}
      </td>
    </tr>
...
function HistoryPopup({ row, title, onClose, mode = "opex" }) {
  ...
  const rows = history.map(h => {
    ...
    if (isInitial || h.tipe === "penambahan") { real = isInitial ? h.nilai : h.nilai; totalReal += h.nilai; jumlah = h.nilai; }
    else if (h.tipe === "pengurangan") { real = -h.nilai; totalReal -= h.nilai; jumlah = -h.nilai; }
    else if (h.tipe === "bymhd" || h.tipe === "transfer") { bymhd = h.nilai; totalBymhd += h.nilai; jumlah = h.nilai; }
              ...
              <tbody>
                {rows.map((h, i) => (
                  <tr key={h.id}>
                    ...
                    <td style={{ ...S.td, textAlign:"right", color: h.real===null?"#cbd5e1": h.real<0?"#ef4444":"#16a34a" }}>{h.real!==null ? <>{h.real<0?"−":""}{fmt(Math.abs(h.real))}</> : "—"}</td>
                    <td style={{ ...S.td, textAlign:"right", color:"#d97706" }}>{h.bymhd!==null ? fmt(h.bymhd) : <span style={{ color:"#cbd5e1" }}>—</span>}</td>
                    <td style={{ ...S.td, textAlign:"right", fontWeight:600, color:(h.jumlah||0)<0?"#ef4444":"#1e293b" }}>{h.jumlah<0?"−":""}{fmt(Math.abs(h.jumlah||0))}</td>
                  </tr>
                ))}
              </tbody>
              <tfoot><tr style={{ background:"#f8fafc" }}>
                <td colSpan={5} style={{ ...S.td, textAlign:"right", fontWeight:600, color:"#475569" }}>TOTAL {lbl.toUpperCase()} SAAT INI</td>
                <td style={{ ...S.td, textAlign:"right", fontWeight:700, color:"#2563eb", fontSize:"0.9rem" }}>{fmt(totalReal + totalBymhd)}</td>
              </tr></tfoot>
            </table>
          )}
        </div>
        <div style={{ padding:"16px", borderTop:"1px solid #e2e8f0", display:"flex", justifyContent:"flex-end" }}>
          <button style={S.btnOut} onClick={onClose}>Tutup</button>
        </div>
      </div>
    </div>
  );
...
function EditSection({ row, masterNama, onBack, onSave, onUpdateRow, mode = "opex" }) {
  const [tipe, setTipe] = useState("");
  const [nilai, setNilai] = useState("");
  const [ket, setKet] = useState("");

  const OPEX_OPTS = [
    { value:"penambahan", label:"Penambahan Realisasi", color:"#16a34a", bg:"#f0fdf4" },
    { value:"pengurangan", label:"Pengurangan Realisasi", color:"#dc2626", bg:"#fef2f2" },
    { value:"bymhd", label:"BYMHD", color:"#d97706", bg:"#fffbeb" },
    { value:"transfer", label:"Transfer Realisasi", color:"#7c3aed", bg:"#f5f3ff" },
  ];
  const CAPEX_OPTS = [
  ...
  const handleSubmit = () => {
    ...
    const newEntry = { id: uid(), tgl: new Date().toISOString().split("T")[0], tipe, nilai: parseFloat(nilai) || 0, keterangan: ket, is_initial: false };
  ...
  const totalLbl = mode === "opex" ? "Total Realisasi Berjalan" : "Total Anggaran Berjalan";
  ...
  return (
    <div style={{ border:"1px solid #e2e8f0", borderRadius:8, overflow:"hidden", marginTop:12 }}>
      <table style={{ ...S.tbl, border:"none" }}>
        ...
        <tbody>
          <InlineEditField label={lbl} value={masterNama} onSave={v => onUpdateRow && onUpdateRow({ masterNama: v })} />
          <InlineEditField label="Tahun" value={row.thn} type="year" onSave={v => onUpdateRow && onUpdateRow({ thn: v })} />
          <InlineEditField label={totalLbl} value={currentTotal} type="currency" onSave={v => onUpdateRow && onUpdateRow({ overrideTotal: v })} />
        </tbody>
      </table>
      <div style={{ borderTop:"1px solid #e2e8f0", background:"#fafafa" }}>
        {[
          { label: "Jenis Perubahan", required: true, content: (
            <select style={{ ...S.inp, width:"auto", minWidth:220, maxWidth:340, background: selOpt?.bg || "white", color: selOpt?.color || "#334155", border: tipe ? `2px solid ${selOpt?.color}` : "1px solid #cbd5e1", fontWeight: tipe ? 700 : 400 }} value={tipe} onChange={e => setTipe(e.target.value)}>
              <option value="">— Pilih Jenis Perubahan —</option>
              {OPTS.map(opt => <option key={opt.value} value={opt.value}>{opt.label}</option>)}
            </select>
          )},
          { label: "Nilai Perubahan (IDR)", required: true, content: (
            <div style={{ display:"flex", alignItems:"center", gap:12, flex:1 }}>
              <input type="number" className="no-spinners" style={{ ...S.inp, width:"auto", flex:1, maxWidth:280 }} placeholder="Contoh: 50000000" value={nilai} onChange={e => setNilai(e.target.value)} />
              {parseFloat(nilai) > 0 && <span style={{ fontSize:"0.78rem", color:"#64748b", whiteSpace:"nowrap" }}>≈ {fmt(nilai)}</span>}
            </div>
          )},
          { label: "Keterangan", content: (
            <input style={{ ...S.inp, maxWidth:400, width:"100%" }} placeholder="Catatan perubahan..." value={ket} onChange={e => setKet(e.target.value)} />
          )},
        ].map((r, i, arr) => (
          <div key={r.label} style={{ ...S.lrRow, borderBottom: i < arr.length-1 ? "1px solid #f1f5f9" : "none" }}>
            <div style={S.lrLabel}>{r.label}{r.required && <span style={{ color:"#ef4444", marginLeft:2 }}>*</span>}</div>
      ...
      <div style={{ padding:"12px 18px", borderTop:"1px solid #e2e8f0", background:"#f8fafc", display:"flex", justifyContent:"flex-end", gap:10 }}>
        <button style={{ ...S.btnOut, fontSize:"0.82rem" }} onClick={onBack}>Batal</button>
        <button style={{ ...S.btn, background: mode === "opex" ? "#ea580c" : "#2563eb", opacity:!tipe||!nilai?0.5:1, padding:"9px 18px", borderRadius:8 }} disabled={!tipe||!nilai} onClick={handleSubmit}>
          {mode === "opex" ? <><Save size={15}/> Submit Perubahan</> : <><PlusCircle size={15}/> Tambah Perubahan</>}
        </button>
      </div>
    </div>
  );
...
function RealisasiSection({ master, setMasters, toast_ }) {
  ...
  const [form, setForm] = useState({ thn: new Date().getFullYear(), realisasi_murni: "", realisasi_bymhd: "" });
  ...
  const handleSaveNew = () => {
    ...
    setShowForm(false);
    setForm({ thn: new Date().getFullYear(), realisasi_murni:"", realisasi_bymhd:"" });
  };

  const handleSavePerubahan = (rowId, newEntry, tipe, nilai) => {
    setMasters(prev => prev.map(m => {
      if (m.id !== master.id) return m;
      return { ...m, realisasi_tahunan: (m.realisasi_tahunan||[]).map(r => {
        if (r.id !== rowId) return r;
        let newMurni = r.realisasi_murni, newBymhd = r.realisasi_bymhd || 0;
        if (tipe === "pengurangan") newMurni -= nilai;
        else if (tipe === "penambahan" || tipe === "bymhd" || tipe === "transfer") newBymhd += nilai;
        return { ...r, realisasi_murni: newMurni, realisasi_bymhd: newBymhd, history: [...(r.history||[]), newEntry] };
      })};
    }));
  ...
  const handleUpdateRow = (rowId, changes) => {
    setMasters(prev => prev.map(m => {
      ...
      return { ...updated, realisasi_tahunan: (m.realisasi_tahunan||[]).map(r => {
        if (r.id !== rowId) return r;
        let upd = { ...r };
        ...
        if (changes.overrideTotal !== undefined) {
          ...
          upd.history = [...(r.history||[]), { id: uid(), tgl: new Date().toISOString().split("T")[0], tipe: selisih>=0?"penambahan":"pengurangan", nilai: Math.abs(selisih), keterangan:"Edit langsung total realisasi berjalan", is_initial:false }];
        }
        return upd;
      })};
    }));
  ...
  const handleDelete = (rowId) => setConfirm({ msg:"Hapus data realisasi tahunan ini?", onConfirm: () => {
    setMasters(prev => prev.map(m => m.id === master.id ? { ...m, realisasi_tahunan: (m.realisasi_tahunan||[]).filter(r => r.id !== rowId) } : m));
    setConfirm(null); toast_("Data realisasi dihapus.");
  }});
  ...
  return (
    <div>
      ...
      {historyRow && <HistoryPopup row={historyRow} title={master.nama} onClose={() => setHistoryRow(null)} mode="opex" />}
        ...
        <div style={S.ovs} onClick={() => setShowForm(false)}>
          <div style={{ background:"white", borderRadius:12, padding:24, maxWidth:420, width:"100%", boxShadow:"0 10px 25px rgba(0,0,0,.1)" }} onClick={e => e.stopPropagation()}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:20 }}>
              <div><h3 style={{ fontWeight:600, fontSize:"1rem" }}>Input Realisasi Tahunan</h3><div style={{ fontSize:"0.78rem", color:"#64748b", marginTop:2 }}>{master.nama}</div></div>
            ...
            <div style={{ border:"1px solid #f1f5f9", borderRadius:8, overflow:"hidden", marginBottom:16 }}>
              <ModalFormRow label="Tahun Realisasi" required>
                <select style={S.inp} value={form.thn} onChange={e => setForm(f => ({ ...f, thn: e.target.value }))}>{yearOpts.map(y => <option key={y} value={y}>{y}</option>)}</select>
              </ModalFormRow>
              <ModalFormRow label="Realisasi Murni (Rp)" required>
                <input type="number" className="no-spinners" style={S.inp} placeholder="0" value={form.realisasi_murni} onChange={e => setForm(f => ({ ...f, realisasi_murni: e.target.value }))} />
              </ModalFormRow>
              <ModalFormRow label="Realisasi BYMHD (Rp)" noBorder>
                <input type="number" className="no-spinners" style={S.inp} placeholder="0" value={form.realisasi_bymhd} onChange={e => setForm(f => ({ ...f, realisasi_bymhd: e.target.value }))} />
              </ModalFormRow>
            </div>
            <div style={{ display:"flex", gap:10, marginTop:20, justifyContent:"flex-end" }}>
              <button style={S.btnOut} onClick={() => setShowForm(false)}>Batal</button>
              <button style={{ ...S.btn, background:"#16a34a", opacity: form.realisasi_murni ? 1 : 0.5 }} disabled={!form.realisasi_murni} onClick={handleSaveNew}>Simpan</button>
            </div>
          </div>
        </div>
      )}
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"10px 16px", background:"#f8fafc", borderTop:"1px solid #e2e8f0" }}>
        ...
        <button style={{ ...S.btn, background:"#16a34a", padding:"6px 12px", fontSize:"0.75rem" }} onClick={() => setShowForm(true)}><Plus size={12} /> Input Realisasi Baru</button>
      </div>
      ...
      <table style={{ ...S.tbl, border:"none" }}>
        ...
        <tbody>
          {list.length === 0 ? (
            <tr><td colSpan={6} style={{ ...S.td, textAlign:"center", color:"#94a3b8", padding:24, fontSize:"0.82rem", background:"#fafafa", fontStyle:"italic" }}>Belum ada data realisasi tahunan.</td></tr>
          ) : list.map((row, idx) => {
            const total = (row.realisasi_murni||0) + (row.realisasi_bymhd||0);
            return (
              <React.Fragment key={row.id}>
                <tr style={{ background: editRowId===row.id ? "#fffbeb" : "white" }}>
                  <td style={{ ...S.td, textAlign:"center", fontSize:"0.72rem", color:"#94a3b8", fontWeight:700 }}>{idx+1}</td>
                  <td style={{ ...S.td, textAlign:"center", fontWeight:700, color:"#0f172a" }}>{row.thn}</td>
                  <td style={{ ...S.td, textAlign:"right", fontWeight:600, color:"#475569" }}>{fmt(row.realisasi_murni)}</td>
                  <td style={{ ...S.td, textAlign:"right", fontWeight:600, color:"#d97706" }}>{fmt(row.realisasi_bymhd)}</td>
                  <td style={{ ...S.td, textAlign:"right", fontWeight:700, color:"#16a34a" }}>{fmt(total)}</td>
                  <td style={{ ...S.td, textAlign:"center" }}>
                    <div style={{ display:"flex", gap:4, justifyContent:"center" }}>
                      <button style={S.abtn} onClick={() => setEditRowId(editRowId===row.id ? null : row.id)}><Edit size={12} style={{ color:"#d97706" }} /></button>
                      <button style={S.abtn} onClick={() => setHistoryRow({ ...row })}><History size={12} style={{ color:"#2563eb" }} /></button>
                      <button style={S.abtn} onClick={() => handleDelete(row.id)}><Trash2 size={12} style={{ color:"#ef4444" }} /></button>
                    </div>
                  </td>
                </tr>
                {editRowId === row.id && (
                  <tr><td colSpan={6} style={{ padding:"0 16px 16px", background:"#fffbeb", borderBottom:"1px solid #e2e8f0" }}>
                    <EditSection row={row} masterNama={master.nama} onBack={() => setEditRowId(null)} onSave={handleSavePerubahan} onUpdateRow={changes => handleUpdateRow(row.id, changes)} mode="opex" />
                  </td></tr>
                )}
              </React.Fragment>
            );
        ...
        {list.length > 0 && (
          <tfoot><tr style={{ background:"#f0fdf4" }}>
            <td colSpan={4} style={{ ...S.td, textAlign:"right", fontWeight:700, color:"#15803d", fontSize:"0.75rem" }}>GRAND TOTAL</td>
            <td style={{ ...S.td, textAlign:"right", fontWeight:800, color:"#15803d", fontSize:"0.88rem" }}>{fmt(grandTotal)}</td>
            <td style={S.td} />
          </tr></tfoot>
        )}
      </table>
...
function CapexAnggaranTahunanSection({ capex, setCapexList, toast_ }) {
  ...
  const [historyRow, setHistoryRow] = useState(null);
  const [confirm, setConfirm] = useState(null);
  const [form, setForm] = useState({ thn: new Date().getFullYear(), nilai_anggaran: "" });
  ...
  const handleSaveNew = () => {
    const today = new Date().toISOString().split("T")[0];
    const payload = { id: uid(), thn: parseInt(form.thn), nilai_anggaran: parseFloat(form.nilai_anggaran)||0,
      history: [{ id: uid(), tgl: today, tipe:"initial", nilai: parseFloat(form.nilai_anggaran)||0, keterangan:"Input awal", is_initial:true }],
    };
    setCapexList(prev => prev.map(c => c.id===capex.id ? { ...c, anggaran_tahunan: [...(c.anggaran_tahunan||[]), payload] } : c));
  ...
  const handleSavePerubahan = (rowId, newEntry, tipe, nilai) => {
    setCapexList(prev => prev.map(c => {
      if (c.id !== capex.id) return c;
      return { ...c, anggaran_tahunan: (c.anggaran_tahunan||[]).map(r => {
        if (r.id !== rowId) return r;
        let newNilai = r.nilai_anggaran;
        if (tipe === "pengurangan") newNilai -= nilai;
        else if (tipe === "penambahan") newNilai += nilai;
        return { ...r, nilai_anggaran: newNilai, history: [...(r.history||[]), newEntry] };
      })};
    }));
  ...
  const handleUpdateRow = (rowId, changes) => {
    setCapexList(prev => prev.map(c => {
      if (c.id !== capex.id) return c;
      let updated = { ...c };
      if (changes.masterNama !== undefined) updated.nm_anggaran = changes.masterNama;
      return { ...updated, anggaran_tahunan: (c.anggaran_tahunan||[]).map(r => {
        if (r.id !== rowId) return r;
        let upd = { ...r };
        if (changes.thn !== undefined) upd.thn = changes.thn;
        if (changes.overrideTotal !== undefined) {
          ...
          upd.history = [...(r.history||[]), { id: uid(), tgl: new Date().toISOString().split("T")[0], tipe: selisih>=0?"penambahan":"pengurangan", nilai: Math.abs(selisih), keterangan:"Edit langsung total anggaran berjalan", is_initial:false }];
        }
        return upd;
      })};
    }));
  ...
  const handleDelete = (rowId) => setConfirm({ msg:"Hapus data anggaran tahunan ini?", onConfirm: () => {
    setCapexList(prev => prev.map(c => c.id===capex.id ? { ...c, anggaran_tahunan: (c.anggaran_tahunan||[]).filter(r => r.id!==rowId) } : c));
    setConfirm(null); toast_("Data anggaran dihapus.");
  }});

  return (
    <div style={{ padding:"0 20px 20px" }}>
      {confirm && <ConfirmBox msg={confirm.msg} onConfirm={confirm.onConfirm} onCancel={() => setConfirm(null)} />}
      {historyRow && <HistoryPopup row={historyRow} title={capex.nm_anggaran} onClose={() => setHistoryRow(null)} mode="capex" />}

      {showForm && (
        <div style={S.ovs} onClick={() => setShowForm(false)}>
          <div style={{ background:"white", borderRadius:12, padding:24, maxWidth:420, width:"100%", boxShadow:"0 10px 25px rgba(0,0,0,.1)" }} onClick={e => e.stopPropagation()}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:20 }}>
              <div><h3 style={{ fontWeight:600, fontSize:"1rem" }}>Input Anggaran Baru</h3><div style={{ fontSize:"0.78rem", color:"#64748b", marginTop:2 }}>{capex.nm_anggaran}</div></div>
              <button style={{ background:"transparent", border:"none", cursor:"pointer", color:"#64748b" }} onClick={() => setShowForm(false)}><X size={20} /></button>
            </div>
            <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
              ...
              <Fld label="Nilai Anggaran (Rp)" required>
                <input type="number" className="no-spinners" style={S.inp} placeholder="0" value={form.nilai_anggaran} onChange={e => setForm(f => ({ ...f, nilai_anggaran: e.target.value }))} />
              </Fld>
            </div>
            <div style={{ display:"flex", gap:10, marginTop:20, justifyContent:"flex-end" }}>
              <button style={S.btnOut} onClick={() => setShowForm(false)}>Batal</button>
              <button style={{ ...S.btn, background:"#16a34a", opacity: form.nilai_anggaran ? 1 : 0.5 }} disabled={!form.nilai_anggaran} onClick={handleSaveNew}>Simpan</button>
            </div>
          </div>
        </div>
      )}

      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"10px 16px", background:"#f8fafc", borderTop:"1px solid #e2e8f0", border:"1px solid #e2e8f0", borderRadius:"8px 8px 0 0" }}>
        <div style={{ display:"flex", alignItems:"center", gap:6 }}>
          <Calendar size={14} style={{ color:"#2563eb" }} />
          <span style={{ fontSize:"0.8rem", fontWeight:700, color:"#374151" }}>Daftar Anggaran per Tahun</span>
          <span style={{ fontSize:"0.72rem", color:"#64748b", background:"#e2e8f0", padding:"1px 7px", borderRadius:99, fontWeight:600 }}>{list.length} tahun</span>
        </div>
        <button style={{ ...S.btn, background:"#2563eb", padding:"6px 12px", fontSize:"0.75rem" }} onClick={() => setShowForm(true)}><Plus size={12} /> Input Anggaran</button>
      </div>
      ...
      <div style={{ border:"1px solid #e2e8f0", borderRadius:"0 0 8px 8px", overflow:"hidden" }}>
        <table style={{ ...S.tbl, border:"none" }}>
          ...
          <tbody>
            {list.length === 0 ? (
              <tr><td colSpan={6} style={{ ...S.td, textAlign:"center", color:"#94a3b8", padding:24, fontSize:"0.82rem", background:"#fafafa", fontStyle:"italic" }}>Belum ada data anggaran di tabel ini.</td></tr>
            ) : list.map((row, idx) => {
              ...
              return (
                <React.Fragment key={row.id}>
                  <tr style={{ background: editRowId===row.id ? "#fffbeb" : "white" }}>
                    <td style={{ ...S.td, textAlign:"center", fontSize:"0.72rem", color:"#94a3b8", fontWeight:700 }}>{idx+1}</td>
                    <td style={{ ...S.td, textAlign:"center", fontWeight:700, color:"#0f172a" }}>{row.thn}</td>
                    <td style={{ ...S.td, textAlign:"right", fontWeight:600, color: real<0?"#ef4444":"#16a34a" }}>{fmt(Math.abs(real))}</td>
                    <td style={{ ...S.td, textAlign:"right", fontWeight:600, color: bymhd>0?"#d97706":"#cbd5e1" }}>{fmt(bymhd)}</td>
                    <td style={{ ...S.td, textAlign:"right", fontWeight:700, color:"#1d4ed8" }}>{fmt(total)}</td>
                    <td style={{ ...S.td, textAlign:"center" }}>
                      <div style={{ display:"flex", gap:4, justifyContent:"center" }}>
                        <button style={S.abtn} onClick={() => setEditRowId(editRowId===row.id ? null : row.id)}><Edit size={12} style={{ color:"#d97706" }} /></button>
                        <button style={S.abtn} onClick={() => setHistoryRow({ ...row })}><History size={12} style={{ color:"#2563eb" }} /></button>
                  ...
                  {editRowId === row.id && (
                    <tr><td colSpan={6} style={{ padding:"0 16px 16px", background:"#fffbeb", borderBottom:"1px solid #e2e8f0" }}>
                      <EditSection row={row} masterNama={capex.nm_anggaran} onBack={() => setEditRowId(null)} onSave={handleSavePerubahan} onUpdateRow={changes => handleUpdateRow(row.id, changes)} mode="capex" />
                    </td></tr>
                  )}
                </React.Fragment>
              );
          ...
          {list.length > 0 && (
            <tfoot><tr style={{ background:"#eff6ff" }}>
              <td colSpan={2} style={{ ...S.td, textAlign:"right", fontWeight:700, color:"#1d4ed8", fontSize:"0.75rem" }}>GRAND TOTAL</td>
              <td style={{ ...S.td, textAlign:"right", fontWeight:800, color:"#16a34a", fontSize:"0.88rem" }}>{fmt(list.reduce((acc,r) => acc + calcRealBymhd(r.history).real, 0))}</td>
              <td style={{ ...S.td, textAlign:"right", fontWeight:800, color:"#d97706", fontSize:"0.88rem" }}>{fmt(list.reduce((acc,r) => acc + calcRealBymhd(r.history).bymhd, 0))}</td>
              <td style={{ ...S.td, textAlign:"right", fontWeight:800, color:"#2563eb", fontSize:"0.88rem" }}>{fmt(list.reduce((acc,r) => acc + calcRealBymhd(r.history).total, 0))}</td>
              <td style={S.td} />
            </tr></tfoot>
          )}
        </table>
      ...
      <div style={{ background:"white", borderRadius:12, border:"1px solid #bfdbfe", overflow:"hidden", boxShadow:"0 4px 12px rgba(0,0,0,.04)" }}>
        <div style={{ background:"#eff6ff", borderBottom:"1px solid #bfdbfe", padding:"20px 24px" }}>
          <div style={{ display:"flex", alignItems:"flex-start", gap:16 }}>
            <div style={{ minWidth:44, height:44, borderRadius:10, background:"#2563eb", display:"flex", alignItems:"center", justifyContent:"center", color:"white", flexShrink:0 }}><Layers size={22} /></div>
            <div style={{ flex:1 }}>
              <div style={{ fontSize:"0.72rem", fontWeight:700, color:"#2563eb", textTransform:"uppercase", letterSpacing:"0.5px", marginBottom:4 }}>Detail Anggaran CAPEX</div>
              <h2 style={{ fontWeight:800, color:"#0f172a", fontSize:"1.15rem", lineHeight:1.3, marginBottom:8 }}>{capex.nm_anggaran}</h2>
              <div style={{ display:"flex", alignItems:"center", gap:10, flexWrap:"wrap" }}>
                <span style={{ fontSize:"0.75rem", fontFamily:"monospace", color:"#1d4ed8", background:"white", padding:"2px 8px", borderRadius:4, border:"1px solid #bfdbfe", fontWeight:700 }}>{capex.kd_capex || "KODE_KOSONG"}</span>
                <span style={{ fontSize:"0.75rem", color:"#64748b", background:"white", padding:"2px 8px", borderRadius:4, border:"1px solid #e2e8f0", fontWeight:600 }}>RKAP {capex.thn_rkap_awal} — {capex.thn_rkap_akhir}</span>
              </div>
            </div>
          </div>
        </div>
        <div style={{ padding:"20px 0 0" }}>
          <CapexAnggaranTahunanSection capex={capex} setCapexList={setCapexList} toast_={toast_} />
        </div>
      </div>
    </div>
  );
    ...
    <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
      ...
      <div style={{ background:"white", border:"1px solid #e2e8f0", borderRadius:10, overflow:"hidden" }}>
        <div style={{ padding:"14px 18px", borderBottom:"1px solid #f1f5f9", background:"#f8fafc", display:"flex", alignItems:"center", gap:8 }}>
          <PlusCircle size={15} style={{ color:"#2563eb" }} /><span style={{ fontSize:"0.85rem", fontWeight:700, color:"#374151" }}>Form Entri Anggaran Baru</span>
        </div>
      ...
      <div style={{ background:"white", border:"1px solid #e2e8f0", borderRadius:10, overflow:"hidden" }}>
        ...
        {history.length === 0 ? (
          ...
          <div style={{ padding:"16px 20px", display:"flex", flexDirection:"column", gap:8 }}>
            {history.map(h => (
              <div key={h.id} style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"10px 14px", background:"#f8fafc", borderRadius:6, border:"1px solid #e2e8f0", fontSize:"0.85rem" }}>
                <span style={{ color:"#1e293b", fontWeight:600 }}>{h.thn_anggaran || h.thn_rkap_akhir}</span>
                <span style={{ color:"#64748b" }}>—</span>
                <span style={{ color:"#16a34a", fontWeight:700 }}>{fmt(h.nilai_rkap)}</span>
              </div>
            ))}
          </div>
        )}
...
function OpexModule({ masterList, setMasterList }) {
  ...
  const emptyForm = { nama:"", kd:"", thn_anggaran: new Date().getFullYear(), nilai_anggaran:"" };
  const [addForm, setAddForm] = useState(emptyForm);
  const [editForm, setEditForm] = useState(emptyForm);

  const handleAddMaster = () => {
    if (!addForm.nama || !addForm.nilai_anggaran) return;
    setMasters(p => [...p, { id: uid(), kd: addForm.kd||uid(), nama: addForm.nama, thn_anggaran: parseInt(addForm.thn_anggaran), nilai_anggaran: parseFloat(addForm.nilai_anggaran)||0, realisasi_tahunan:[] }]);
    toast_("Anggaran master baru ditambahkan."); setShowAddMaster(false); setAddForm(emptyForm);
  };

  const handleSaveEditMaster = () => {
    if (!editForm.nama || !editForm.nilai_anggaran) return;
    setMasters(p => p.map(m => m.id===editModalMaster.id ? { ...m, nama:editForm.nama, kd:editForm.kd, thn_anggaran:parseInt(editForm.thn_anggaran), nilai_anggaran:parseFloat(editForm.nilai_anggaran) } : m));
    toast_("Data master diperbarui."); setEditModalMaster(null); setEditForm(emptyForm);
  };

  const handleDeleteMaster = (id) => setConfirm({ msg:"Hapus anggaran master ini beserta seluruh data realisasinya?", onConfirm: () => {
    setMasters(p => p.filter(m => m.id !== id)); setConfirm(null); toast_("Anggaran master dihapus.");
  }});
  ...
  const namaOptions = useMemo(() => {
    ...
    const seen = new Set();
    return pool.map(m => ({ id:m.id, nama:m.nama })).filter(item => { if (seen.has(item.nama)) return false; seen.add(item.nama); return true; }).sort((a,b) => a.nama.localeCompare(b.nama));
  ...
  const MasterFormModal = ({ title, form, setForm, onSave, onClose }) => (
    <div style={S.ovs} onClick={onClose}>
      <div style={{ background:"white", borderRadius:12, padding:28, maxWidth:620, width:"100%", boxShadow:"0 10px 25px rgba(0,0,0,.1)" }} onClick={e => e.stopPropagation()}>
        ...
        <div style={{ border:"1px solid #f1f5f9", borderRadius:8, overflow:"hidden", marginBottom:16 }}>
          {[
            { label:"Nama Anggaran", key:"nama", required:true, placeholder:"Contoh: Beban Pemeliharaan Software" },
            { label:"Kode Anggaran", key:"kd", placeholder:"Contoh: 5030905000" },
          ].map(f => (
            <ModalFormRow key={f.key} label={f.label} required={f.required}>
              <input style={S.inp} placeholder={f.placeholder} value={form[f.key]} onChange={e => setForm(fm => ({ ...fm, [f.key]: e.target.value }))} />
            </ModalFormRow>
          ))}
          <ModalFormRow label="Tahun Anggaran" required>
            <select style={S.inp} value={form.thn_anggaran} onChange={e => setForm(fm => ({ ...fm, thn_anggaran: e.target.value }))}>{yearOpts.map(y => <option key={y} value={y}>{y}</option>)}</select>
          </ModalFormRow>
          <ModalFormRow label="Nilai Anggaran (Rp)" required noBorder>
            <div style={{ display:"flex", alignItems:"center", gap:8 }}>
              <input type="number" className="no-spinners" style={{ ...S.inp, flex:1 }} placeholder="0" value={form.nilai_anggaran} onChange={e => setForm(fm => ({ ...fm, nilai_anggaran: e.target.value }))} />
              {parseFloat(form.nilai_anggaran) > 0 && <span style={{ fontSize:"0.75rem", color:"#64748b", whiteSpace:"nowrap" }}>≈ {fmt(form.nilai_anggaran)}</span>}
            </div>
          </ModalFormRow>
        </div>
        <div style={{ display:"flex", gap:10, justifyContent:"flex-end" }}>
          <button style={S.btnOut} onClick={onClose}>Batal</button>
          <button style={{ ...S.btn, background:"#16a34a", opacity: form.nama&&form.nilai_anggaran?1:0.5 }} disabled={!form.nama||!form.nilai_anggaran} onClick={onSave}><Plus size={14} /> {title.includes("Edit") ? "Simpan Perubahan" : "Tambahkan"}</button>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
      ...
      {confirm && <ConfirmBox msg={confirm.msg} onConfirm={confirm.onConfirm} onCancel={() => setConfirm(null)} />}
      {showAddMaster && <MasterFormModal title="Tambah Anggaran Master OPEX" form={addForm} setForm={setAddForm} onSave={handleAddMaster} onClose={() => setShowAddMaster(false)} />}
      {editModalMaster && <MasterFormModal title="Edit Anggaran Master" form={editForm} setForm={setEditForm} onSave={handleSaveEditMaster} onClose={() => setEditModalMaster(null)} />}

      {detailMaster && (() => {
        const latest = masters.find(m => m.id === detailMaster.id) || detailMaster;
        const totalR = (latest.realisasi_tahunan||[]).reduce((s,r) => s+(r.realisasi_murni||0)+(r.realisasi_bymhd||0), 0);
            ...
            <div style={{ background:"white", borderRadius:12, border:"1px solid #bbf7d0", overflow:"hidden", boxShadow:"0 4px 12px rgba(0,0,0,.04)" }}>
              <div style={{ background:"#f0fdf4", borderBottom:"1px solid #bbf7d0", padding:"16px 24px" }}>
                <div style={{ display:"flex", alignItems:"flex-start", gap:14 }}>
                  <div style={{ minWidth:40, height:40, borderRadius:9, background:"#16a34a", display:"flex", alignItems:"center", justifyContent:"center", color:"white", flexShrink:0 }}><Database size={20} /></div>
                  <div style={{ flex:1 }}>
                    <div style={{ fontSize:"0.68rem", fontWeight:700, color:"#16a34a", textTransform:"uppercase", letterSpacing:"0.5px", marginBottom:2 }}>Detail Realisasi OPEX</div>
                    <h2 style={{ fontWeight:800, color:"#0f172a", fontSize:"1.05rem", lineHeight:1.3, marginBottom:6 }}>{latest.nama}</h2>
                    <div style={{ display:"flex", alignItems:"center", gap:8, flexWrap:"wrap" }}>
                      <span style={{ fontSize:"0.75rem", fontFamily:"monospace", color:"#15803d", background:"white", padding:"2px 8px", borderRadius:4, border:"1px solid #bbf7d0", fontWeight:700 }}>{latest.kd}</span>
                      <span style={{ fontSize:"0.75rem", color:"#64748b", background:"white", padding:"2px 8px", borderRadius:4, border:"1px solid #e2e8f0", fontWeight:600 }}>Anggaran: {fmt(latest.nilai_anggaran)}</span>
                      <span style={{ fontSize:"0.75rem", background: pct>=100?"#fef2f2":pct>=80?"#fffbeb":"#f0fdf4", color: pct>=100?"#dc2626":pct>=80?"#d97706":"#16a34a", padding:"2px 8px", borderRadius:4, border:`1px solid ${pct>=100?"#fecaca":pct>=80?"#fde68a":"#bbf7d0"}`, fontWeight:700 }}>Realisasi {pct}%</span>
                    </div>
                  </div>
                  <button style={{ ...S.abtn, padding:"6px 10px", background:"#fffbeb", borderColor:"#fde68a" }} title="Edit Master" onClick={() => { setEditModalMaster(latest); setEditForm({ nama:latest.nama, kd:latest.kd, thn_anggaran:latest.thn_anggaran, nilai_anggaran:latest.nilai_anggaran }); }}>
                    <Edit size={14} style={{ color:"#d97706" }} />
                  </button>
                </div>
              </div>
              <RealisasiSection master={latest} setMasters={setMasters} toast_={toast_} />
            </div>
          </div>
        );
      })()}
      ...
      <div style={{ background:"white", border:"1px solid #e2e8f0", borderRadius:10, overflow:"hidden" }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"14px 18px", borderBottom:"1px solid #f1f5f9" }}>
          ...
          <button style={{ ...S.btn, background:"#16a34a", padding:"8px 14px", fontSize:"0.78rem" }} onClick={() => setShowAddMaster(true)}><Plus size={13} /> Tambah Anggaran Master</button>
        </div>
        ...
        <div style={{ padding:"10px 18px", background:"#f8fafc", borderBottom:"1px solid #f1f5f9" }}>
          <div style={{ display:"flex", alignItems:"center", gap:10, flexWrap:"wrap" }}>
            <div style={{ display:"flex", alignItems:"center", gap:6, flexShrink:0 }}>
              ...
              <span style={{ fontSize:"0.72rem", fontWeight:700, color:"#94a3b8", textTransform:"uppercase", letterSpacing:"0.5px" }}>Filter</span>
            </div>
            <div style={{ display:"flex", alignItems:"center", gap:6 }}>
              <span style={{ fontSize:"0.78rem", color:"#64748b", whiteSpace:"nowrap" }}>Tahun</span>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:6, flex:1, minWidth:200 }}>
              <span style={{ fontSize:"0.78rem", color:"#64748b", whiteSpace:"nowrap" }}>Pos</span>
              <div style={{ position:"relative", flex:1, maxWidth:440 }}>
                <select style={{ ...S.inp, padding:"6px 32px 6px 10px", fontSize:"0.8rem", background: filterNama?"#f0fdf4":"white", border: filterNama?"1px solid #bbf7d0":"1px solid #cbd5e1", color: filterNama?"#15803d":"#475569", fontWeight: filterNama?600:400 }}
                  value={filterNama} onChange={e => { setFilterNama(e.target.value); setCurrentPage(1); }}>
                  <option value="">{namaOptions.length===0 ? "— Tidak ada pos —" : `— Pilih Pos Anggaran (${namaOptions.length}) —`}</option>
                  {namaOptions.length > 0 && <option value="SEMUA">— Semua Pos —</option>}
                  {namaOptions.map(item => <option key={item.id} value={item.nama}>{item.nama}</option>)}
                </select>
                {filterNama && (
                  <button style={{ position:"absolute", right:6, top:"50%", transform:"translateY(-50%)", background:"transparent", border:"none", cursor:"pointer", display:"flex", alignItems:"center", color:"#94a3b8", padding:2 }}
                    onClick={() => { setFilterNama(""); setCurrentPage(1); }}>
                    <X size={13} />
                  </button>
                )}
              </div>
          ...
          <>
            <div style={{ background:"white", border:"1px solid #e2e8f0", borderRadius:10, overflow:"hidden" }}>
              <div style={{ overflowX:"auto" }}>
                <table style={{ ...S.tbl, border:"none" }}>
                  <thead><tr>
                    {["NO","NAMA ANGGARAN","KODE","TAHUN","NILAI ANGGARAN","REALISASI TOTAL","REALISASI %","AKSI"].map((h, i) => (
                      <th key={h} style={{ ...S.th, ...(i===0&&{width:48,textAlign:"center"}), ...(i===2&&{width:90,textAlign:"center"}), ...(i===3&&{width:80,textAlign:"center"}), ...(i===4&&{width:140,textAlign:"right"}), ...(i===5&&{width:140,textAlign:"right"}), ...(i===6&&{width:100,textAlign:"center"}), ...(i===7&&{width:130,textAlign:"center"}) }}>{h}</th>
                    ))}
                  </tr></thead>
                  <tbody>
                    {paginatedWithIdx.map(({ m, globalIdx }) => {
                      ...
                      return (
                        <tr key={m.id} style={{ background:"white", cursor:"default" }}>
                          <td style={{ ...S.td, textAlign:"center", fontWeight:700, fontSize:"0.78rem", color:"#94a3b8" }}>{globalIdx+1}</td>
                          <td style={S.td}>
                            <div style={{ fontWeight:600, color:"#1e293b", lineHeight:1.4, fontSize:"0.88rem" }}>{m.nama}</div>
                          </td>
                          <td style={{ ...S.td, textAlign:"center" }}><span style={{ fontFamily:"monospace", background:"#f1f5f9", color:"#475569", padding:"3px 8px", borderRadius:4, fontWeight:700, fontSize:"0.8rem" }}>{m.kd}</span></td>
                          <td style={{ ...S.td, textAlign:"center", color:"#64748b", fontWeight:600 }}>{m.thn_anggaran}</td>
                          <td style={{ ...S.td, textAlign:"right" }}><span style={{ fontWeight:700, color:"#1e293b" }}>{fmt(m.nilai_anggaran)}</span></td>
                          <td style={{ ...S.td, textAlign:"right" }}><span style={{ fontWeight:700, color: pctColor(pct) }}>{fmt(totalR)}</span></td>
                          <td style={{ ...S.td, textAlign:"center" }}>
                            <span style={{ background: pct>=100?"#f0fdf4":pct>=50?"#fef3c7":"#fecaca", color: pct>=100?"#16a34a":pct>=50?"#b45309":"#dc2626", border: `1px solid ${pct>=100?"#bbf7d0":pct>=50?"#fde68a":"#fecaca"}`, padding:"3px 10px", borderRadius:99, fontWeight:700, fontSize:"0.78rem" }}>{pct}%</span>
                          </td>
                          <td style={{ ...S.td, textAlign:"center" }}>
                            <div style={{ display:"flex", gap:6, justifyContent:"center" }}>
                              <button style={{ ...S.abtn, padding:"6px 10px", background:"#eff6ff", borderColor:"#bfdbfe" }} title="Lihat Detail Realisasi" onClick={() => setDetailMaster(m)}>
                                <Eye size={13} style={{ color:"#2563eb" }} />
                              </button>
                              <button style={{ ...S.abtn, padding:"6px 10px", background:"#fffbeb", borderColor:"#fde68a" }} onClick={() => { setEditModalMaster(m); setEditForm({ nama:m.nama, kd:m.kd, thn_anggaran:m.thn_anggaran, nilai_anggaran:m.nilai_anggaran }); }}><Edit size={13} style={{ color:"#d97706" }} /></button>
                              <button style={{ ...S.abtn, padding:"6px 10px", background:"#fef2f2", borderColor:"#fecaca" }} onClick={() => handleDeleteMaster(m.id)}><Trash2 size={13} style={{ color:"#ef4444" }} /></button>
                            </div>
                          </td>
                        </tr>
                      );
            ...
            {totalPages > 1 && (
              <div style={{ background:"white", border:"1px solid #e2e8f0", borderRadius:10, padding:"12px 18px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                  <button style={{ ...S.abtn, padding:"6px 12px", opacity: currentPage===1?0.4:1 }} disabled={currentPage===1} onClick={() => setCurrentPage(p => p-1)}><ChevronRight size={14} style={{ transform:"rotate(180deg)", color:"#475569" }} /></button>
                  ...
                  <button style={{ ...S.abtn, padding:"6px 12px", opacity: currentPage===totalPages?0.4:1 }} disabled={currentPage===totalPages} onClick={() => setCurrentPage(p => p+1)}><ChevronRight size={14} style={{ color:"#475569" }} /></button>
                </div>
              </div>
            )}
          </>
...
function CapexModule({ capexList, setCapexList }) {
  ...
  if (detailCapex) {
    ...
    return <div style={{ display:"flex", flexDirection:"column", gap:16 }}>{toast && <ToastMsg msg={toast} onDone={() => setToast(null)} />}<CapexDetailPage capex={latest} onBack={() => setDetailCapex(null)} setCapexList={setCapexList} toast_={toast_} /></div>;
  }
  if (inputAnggaranCapex) {
    const latest = capexList.find(c => c.id===inputAnggaranCapex.id) || inputAnggaranCapex;
    ...
    <div style={S.ovs} onClick={onClose}>
      <div style={{ background:"white", borderRadius:12, width:"100%", maxWidth:600, maxHeight:"90vh", overflowY:"auto", boxShadow:"0 10px 25px rgba(0,0,0,.1)" }} onClick={e => e.stopPropagation()}>
        <div style={{ padding:"16px 20px", borderBottom:"1px solid #e2e8f0", display:"flex", justifyContent:"space-between", alignItems:"center", background:"#f8fafc" }}>
          <h3 style={{ fontWeight:700, fontSize:"1rem", color:"#1e293b" }}>{title}</h3>
          <button style={{ background:"transparent", border:"none", cursor:"pointer", color:"#64748b" }} onClick={onClose}><X size={20} /></button>
        </div>
        <ModalFormRow label="Nama Anggaran" required>
          <textarea rows={2} style={{ ...S.inp, resize:"vertical" }} placeholder="Contoh: Transformasi dan Digitalisasi PT Pelindo" value={data.nm_anggaran} onChange={e => setData(f => ({ ...f, nm_anggaran: e.target.value }))} />
        </ModalFormRow>
      ...
      <div style={{ background:"white", border:"1px solid #e2e8f0", borderRadius:10, padding:"16px 20px", display:"flex", alignItems:"center", gap:14 }}>
        ...
        <div style={{ flex:1 }}>
          ...
          <div style={{ fontSize:"0.82rem", color:"#64748b", marginTop:2 }}>
            <span style={{ fontFamily:"monospace", background:"#dbeafe", color:"#1d4ed8", padding:"1px 6px", borderRadius:4, fontWeight:700, fontSize:"0.78rem", marginRight:8 }}>5900100000</span>Beban Investasi
          </div>
        </div>
        <div style={{ fontSize:"0.72rem", background:"#dbeafe", color:"#1d4ed8", fontWeight:700, padding:"4px 10px", borderRadius:99, border:"1px solid #bfdbfe" }}>{capexList.length} data CAPEX</div>
      </div>
                ...
                const rows = [
                  <tr key={c.id} style={{ background: isLebih?"#fffbeb":"white" }}>
                    ...
                    <td style={S.td}>
                      ...
                      {isLebih && <div style={{ marginTop:4 }}><span style={{ fontSize:"0.68rem", background:"#fef3c7", color:"#b45309", padding:"2px 6px", borderRadius:4, fontWeight:700, border:"1px solid #fde68a" }}>★ RKAP Akhir melewati tahun berjalan</span></div>}
                    </td>
...
export default function App() {
  ...
  if (moduleType === "CAPEX") return wrap(<CapexModule capexList={capexList} setCapexList={setCapexList} />);
  return wrap(<OpexModule masterList={masterList} setMasterList={setMasterList} />);
}